...
* Install k9s
  #+begin_src sh :var version="v0.24.10" :results output silent :dir /sudo::/tmp
    set -e
    curl -L https://github.com/derailed/k9s/releases/download/${version}/k9s_${version}_Linux_x86_64.tar.gz \
